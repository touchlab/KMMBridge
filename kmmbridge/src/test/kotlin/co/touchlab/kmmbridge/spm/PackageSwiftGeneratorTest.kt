...
class PackageSwiftGeneratorTest {
    ...
    fun `generates Package swift for single module`() {
        ...
        val result = PackageSwiftGenerator.generate("my-sdk", "5.9", modules)
    ...
    fun `generates Package swift for multiple modules`() {
        ...
        val result = PackageSwiftGenerator.generate("openai-kotlin", "5.9", modules)
    ...
    fun `resolves maximum swift tools version`() {
        ...
        val version = PackageSwiftGenerator.resolveSwiftToolsVersion(modules, "5.5")
    ...
    fun `uses default swift tools version when none specified`() {
        ...
        val version = PackageSwiftGenerator.resolveSwiftToolsVersion(modules, "5.9")
    ...
    fun `resolves maximum platform versions across modules`() {
        ...
        val platforms = PackageSwiftGenerator.resolvePlatforms(modules)
    ...
    fun `generated Package swift has correct structure`() {
        ...
        val result = PackageSwiftGenerator.generate("test-package", "5.9", modules)
